...
%never move, so wee need to fix that
...
previousDirectionIndex=((previousDirection-1)/2)+(previousDirection<5); %converts the digonal directon to the index, it sets it to 2 on the first move but because the frame is zero this doesn't matter
